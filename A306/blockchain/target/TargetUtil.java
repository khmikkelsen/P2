...
//    private static final String limit = new Target(new BigInteger("00000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", 16)).getCompactTarget();
    private static final Target proofOfWorkLimit = new Target(new BigInteger("0000100000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", 16)); // Very high blockchain.target (difficulty less than 1).
    //private static final Target proofOfWorkLimit = new Target("00000000FFFF0000000000000000000000000000000000000000000000000000"); // Highest blockchain.target (difficulty 1)
...
//        }
        ...
        //Calculate new blockchain.target
        ...
        // Don't allow blockchain.target to exceed limit.
        ...
        //New blockchain.target for nodes; hash must be less than blockchain.target

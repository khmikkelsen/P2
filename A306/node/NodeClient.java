...
import node.mining.Miner;
import node.mining.MiningCompleteListener;
import node.network.NetworkHandler;
import rsa.BadVerificationException;
import rsa.InvalidRSAKeyException;
import rsa.RSAKey;
import rsa.RSAOAEPVerify;
import blockchain.block.BlockUtil;
...
//                System.out.println(JsonUtil.getPrettyParser().toJson(databaseConnection.getBlockTable()));
                ...
                // TODO: Broadcast mined blockchain.block to network.
...
//                System.out.println(JsonUtil.getPrettyParser().toJson(databaseConnection.getBlockTable()));
    ...
    private boolean isBlockValid(Block newBlock, Block previousBlock) {
        ...
        // 4. Must have valid proof of work (hash lower than claimed blockchain.target)
